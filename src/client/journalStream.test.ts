// Conformance tests for the `JournalStream` port. Loads the same shared
// vectors as the Rust side (ported from
// dspo/manox:crates/manox-protocol/test-vectors/journal-cases.json) and
// asserts identical publish sequences and protocol-failure messages, making
// cross-engine equivalence a mechanically checked guarantee. Keep this file
// in sync with the Rust vectors when manox bumps them.

import { describe, expect, it } from 'vitest';

import vectors from './journal-cases.json';
import {
	type JournalChange,
	JournalStream,
	type JournalEntry,
...
describe('JournalStream shared conformance vectors (vscode-host ⇄ manox-protocol)', () => {
